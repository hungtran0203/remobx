...
var ReactionScheduler = (function () {
    ...
    ReactionScheduler.prototype.hasReaction = function (reaction) {
...
var ModelMiddleware = (function () {
    ...
    ModelMiddleware.prototype.getTrackedProps = function (reaction, tag) {
        ...
        var rtn = this.trackedTagsByReaction.get(reaction);
        if (!rtn.has(tag)) {
            rtn.set(tag, new Map());
        }
        return rtn.get(tag);
    ...
    ModelMiddleware.prototype.dispatch = function (change, scheduler) {
        var _this = this;
        ...
        if (reactionSubscribers) {
            reactionSubscribers.forEach(function (reaction) {
                ...
                if (scheduler.hasReaction(reaction))
                    return;
                switch (action) {
                    case ACTIONS.INSERT:
                    case ACTIONS.DELETE:
...
var CollectionMiddleware = (function () {
    ...
    CollectionMiddleware.prototype.dispatch = function (change, scheduler) {
        var _this = this;
    ...
    return function (target, property) {
        ...
        Object.defineProperty(target, property, {
            get: function () {
                ...
                var propVal = store.get(this.getTableName(), this.getKey(), property, defaultValue);
                return propVal;
            },
            set: function (newVal) {
...
var untrack = function (fn) {
    var _runningReaction, _updatingReaction;
    try {
...
})(exports.TableHookType || (exports.TableHookType = {}));
...
var Model = (function () {
    ...
    Model.insert = function (data, opt) {
        ...
        // hook
        this.applyHook(exports.TableHookType.BEFORE_INSERT, [data, opt]);
        ...
        // hook
        this.applyHook(exports.TableHookType.AFTER_INSERT, [data, opt, changes]);
        return rtn;
    };
    Model.findOrNew = function (data, opt) {
        var _this = this;
        untrack(function () {
            var found = _this.findOne(data);
            if (!found) {
                found = _this.insert(data);
            }
        });
        var found = this.findOne(data);
        return found;
    };
...
exports.setTableKey = setTableKey;
...
},{"_process":1,"immutability-helper":3,"lodash":5,"sift":6,"uuid/v4":9}],3:[function(require,module,exports){
