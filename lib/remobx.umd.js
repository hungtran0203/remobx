(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.remobx = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var splice$3 = Array.prototype.splice;

var toString$2 = Object.prototype.toString;
var type = function(obj) {
  return toString$2.call(obj).slice(8, -1);
};

var assign$2 = Object.assign || /* istanbul ignore next */ function assign(target, source) {
  getAllKeys$2(source).forEach(function(key) {
    if (hasOwnProperty$23.call(source, key)) {
...
var getAllKeys$2 = typeof Object.getOwnPropertySymbols === 'function' ?
...
function copy(object) {
  if (Array.isArray(object)) {
    return assign$2(object.constructor(object.length), object)
    ...
    return assign$2(Object.create(prototype || null), object);
  } else {
    return object;
  }
}
...
function newContext() {
  var commands = assign$2({}, defaultCommands);
  ...
  function update(object, spec) {
    ...
    getAllKeys$2(spec).forEach(function(key) {
      if (hasOwnProperty$23.call(commands, key)) {
        ...
        if (!update.isEquals(nextValueForKey, nextObject[key]) || typeof nextValueForKey === 'undefined' && !hasOwnProperty$23.call(object, key)) {
...
var defaultCommands = {
  ...
  $splice: function(value, nextObject, spec, originalObject) {
    ...
    value.forEach(function(args) {
      ...
      splice$3.apply(nextObject, args);
    });
    return nextObject;
  },
  ...
  $merge: function(value, nextObject, spec, originalObject) {
    ...
    getAllKeys$2(value).forEach(function(key) {
...
var FireBase = (function () {
    function FireBase(options, store) {
        ...
        this.store = store;
        this.middlewares = [];
        var middlewares = get(options, 'middlewares');
...
var CollectionMiddleware = (function () {
    ...
    CollectionMiddleware.prototype.parseSubsToken = function (token) {
        ...
        if (type === PARSER_TYPE$1 && table && typeof valGetter === 'function') {
            return __assign({ tag: this.serializeToken(token) }, token);
        }
    };
    CollectionMiddleware.prototype.setTrackedToken = function (reaction, tag, cond, token) {
            ...
            reactionSubscribers.forEach(function (reaction) {
                switch (action) {
                    ...
                    case ACTIONS.UPDATE:
                        ...
                        // check if value is changed
                        var shouldUpdate_1 = false;
                        trackedConditions.forEach(function (token, cond) {
                            // const newVal = 
                            var val = token.val, valGetter = token.valGetter;
    ...
    CollectionMiddleware.prototype.serializeToken = function (token) {
        return "" + token.table;
    };
...
var Store = (function () {
    ...
    Store.prototype.insert = function (table, data) {
        ...
        set(this.data, table + "." + _id, __assign({}, data, (_a = {}, _a[Store._getKeyName(table)] = _id, _a)));
    ...
    Store.prototype.update = function (table, _id, query) {
        ...
        if (_id) {
            set(this.data, table + "." + _id, update(this.data[table][_id], query));
        }
    ...
    Store.prototype.query = function (table, cond, selection) {
        ...
        var tableData = get(this.data, table, {});
    ...
    Store.prototype.delete = function (table, _id) {
        ...
        ids.map(function (_id) {
            var oldData = get(_this.data, table + "." + _id);
    ...
    Store.prototype.get = function (table, _id, property, defaultValue) {
        return get(this.data, table + "." + _id + (property === undefined ? '' : ('.' + property)), defaultValue);
    };
...
var invariant$3 = invariant_;
var Collection = (function () {
    function Collection(Model, items, options) {
        if (options === void 0) { options = {}; }
        this.Model = Model;
        this.items = items;
        this.options = options;
    }
    Collection.getInstance = function (Model, items, options) {
        if (options === void 0) { options = {}; }
        return new Collection(Model, items, options);
    };
    Collection.fromArray = function (models) {
        if (Array.isArray(models)) {
            var Model_1 = get(models, '0.constructor');
            var items = models.map(function (model) {
                invariant$3(model.constructor === Model_1, 'Collection::fromArray only accept an array of Models with the same schema');
                return model.getKey();
            });
            return this.getInstance(Model_1, items);
        }
        return null;
    };
    ...
    Collection.prototype.chunk = function (size) {
        var _this = this;
        var chunks = chunk(this.items, size);
        return chunks.map(function (chunk) { return Collection.getInstance(_this.Model, chunk, _this.options); });
    };
    /**
    ...
    Collection.prototype.find = function (callback, fromIndex) {
        return find(this.all(), callback, fromIndex);
    };
    /**
    ...
    Collection.prototype.findLast = function (callback, fromIndex) {
        return findLast(this.all(), callback, fromIndex);
    };
    /**
    ...
    Collection.prototype.filter = function (callback) {
        var _this = this;
        invariant$3(typeof callback === 'function', "filter callback argument must be a function");
        var filterIds = this.items.filter(function (id, index) {
    ...
    Collection.prototype.map = function (callback) {
        var _this = this;
        invariant$3(typeof callback === 'function', "map callback argument must be a function");
    ...
    Collection.prototype.lists = function (property) {
        ...
        return this.items.map(function (_id) {
            return get(_this.Model.getInstance(_id), property);
        });
    };
    /**
    ...
    Collection.prototype.partition = function (callback) {
        var _a = partition(this.all(), callback), truthyItems = _a[0], falsyItems = _a[1];
    ...
    Collection.prototype.push = function (item) {
        var Model = get(item, 'constructor');
        invariant$3(this.Model === Model, "push item must be an instance of " + this.getType().name);
    ...
    Collection.prototype.concat = function () {
        ...
        var Model = get(items, '0.constructor');
        var ids = items.map(function (item) {
            invariant$3(item.constructor === Model, "Collection::concat only accept additional item is instance of " + _this.getType().name);
            return item.getKey();
        });
    ...
    Collection.prototype.unshift = function (item) {
        var Model = get(item, 'constructor');
        invariant$3(this.Model === Model, "unshift item must be an instance of " + this.getType().name);
    ...
    Collection.prototype.reduce = function (callback, initialValue) {
        var _this = this;
        invariant$3(typeof callback === 'function', "reduce callback argument must be a function");
    ...
    Collection.prototype.reverse = function () {
        var reItems = reverse(this.items.slice());
    ...
    Collection.prototype.splice = function (startIndex, deleteCount) {
        ...
        var newItemIds = [];
        if (newItems.length) {
            var Model_2 = get(newItems, '0.constructor');
            newItemIds = newItems.map(function (item) {
                invariant$3(item.constructor === Model_2, "splice only accept new item instance of " + _this.getType().name);
                return item.getKey();
            });
        }
    ...
    Collection.prototype.sortBy = function (iteratee) {
        var sortedItems = sortBy(this.all(), iteratee);
    ...
    Collection.prototype.orderBy = function (iteratee, orders) {
        var orderedItems = orderBy(this.all(), iteratee, orders);
    ...
    Collection.prototype._doChange = function () {
        var onChange = get(this.options, 'onChange');
...
var invariant$4 = invariant_;
var Field = function (options) {
    if (options === void 0) { options = {}; }
    return function (target, property) {
        var defaultValue = get(options, 'defaultValue');
        var isRequired = get(options, 'required');
        ...
        setDefinition(target.constructor, property, __assign({}, options, { name: 'Field', type: Field, ensureData: function (data, opt) {
                if (opt === void 0) { opt = {}; }
                var val = get(data, property, defaultValue);
                val = typeof val === 'function' ? val() : val;
                // check required
                invariant$4(!(isRequired && val === undefined), "Missing value for required field " + property);
                set(data, property, val);
            }, validation: function () {
            } }));
...
var dispatcher = function (table, action) {
    ...
    switch (type) {
        case ACTIONS.INSERT:
            rtn.changes = store.insert(table, get(action, 'data'));
            break;
        case ACTIONS.UPDATE:
            rtn.changes = store.update(table, get(action, '_id'), get(action, 'query'));
            break;
        case ACTIONS.DELETE:
            rtn.changes = store.delete(table, get(action, '_id'));
            break;
        case ACTIONS.QUERY:
            rtn.data = store.query(table, get(action, 'cond'), get(action, 'selection'));
            break;
    }
    return rtn;
};
var Query = (function () {
    ...
    Query.prototype._getTableName = function () {
        return get(this.options, 'tableName');
    };
    return Query;
}());
...
var Model = (function () {
    ...
    Model.insert = function (data) {
        var res = Connection.table(this.getTableName()).insert(this.ensureData(data)).run();
        var changes = res.changes;
        var rtn;
        if (Array.isArray(changes) && changes.length) {
            var _id = get(changes, '0._id');
    ...
    Model.findById = function (_id) {
        var Model = this;
        var query = Connection.table(Model.getTableName()).find((_a = {}, _a[Model.getKeyName()] = _id, _a), (_b = {}, _b[Model.getKeyName()] = true, _b)).run();
        var data = query.data;
        var rtn;
        if (Array.isArray(data)) {
            var _id_1 = get(data, "0." + Model.getKeyName());
            rtn = this.getInstance(_id_1);
        }
        return rtn;
        var _a, _b;
    };
    Model.findOne = function (cond) {
        ...
        var valGetter = function () {
            ...
            if (Array.isArray(data) && data.length) {
                return get(data, "0." + Model.getKeyName());
            }
            var _a;
        };
        var rtn;
        ...
        var reactionContext = globalState.getReactionContext();
        if (reactionContext) {
            var token = CollectionMiddleware.tokenBuilder({ cond: cond, val: _id, valGetter: valGetter, table: Model.getTableName() });
            reactionContext.track(token);
        }
        return rtn;
    };
    Model.find = function (cond, options) {
        ...
        var valGetter = function () {
            var res = Connection.table(Model.getTableName()).find(cond, (_a = {}, _a[Model.getKeyName()] = true, _a)).run();
            return get(res, 'data').map(function (item) { return item[Model.getKeyName()]; });
            var _a;
        };
        var items = valGetter();
        var rtn = Collection.getInstance(Model, items, options);
        // track enable
        var reactionContext = globalState.getReactionContext();
        if (reactionContext) {
            var token = CollectionMiddleware.tokenBuilder({ cond: cond, val: items, valGetter: valGetter, table: Model.getTableName() });
            reactionContext.track(token);
        }
        return rtn;
    };
...
var hasOne = function (typeFunction, options) {
    if (options === void 0) { options = {}; }
    return function (target, property) {
        var ownerKey = get(options, 'ownerKey', property + "Id");
        // set definition for this field
        setDefinition(target.constructor, property, __assign({}, options, { name: 'hasOne', type: hasOne, ensureData: function (data, opt) {
                ...
                var val = get(data, property);
                if (val instanceof Model) {
                    set(data, ownerKey, val.getKey());
                }
...
var invariant$5 = invariant_;
var hasMany = function (typeFunction, options) {
    if (options === void 0) { options = {}; }
    return function (target, property) {
        var ownerKey = get(options, 'ownerKey', property + "Ids");
        // set definition for this field
        ...
        Object.defineProperty(target, property, {
            get: function () {
                var _this = this;
                var Model = typeFunction();
                var itemIds = this.get(ownerKey);
                if (!Array.isArray(itemIds)) {
                    itemIds = [];
                }
                return Model.find((_a = {}, _a[Model.getKeyName()] = { $in: itemIds }, _a), { onChange: function (items) {
            ...
            set: function (items) {
                ...
                try {
                    ...
                    invariant$5(col.getType() === Model, "hasMany relation requires collection of \"" + Model.name + "\" while receives collection of \"" + col.getType().name + "\"");
...
var invariant$6 = invariant_;
var belongsToMany = function (typeFunction, options) {
    if (options === void 0) { options = {}; }
    return function (target, property) {
        var foreignKey = get(options, 'foreignKey', property + "Id");
        var filter = get(options, 'filter', {});
        // set definition for this field
        ...
        Object.defineProperty(target, property, {
            ...
            set: function (items) {
                ...
                try {
                    ...
                    invariant$6(items.getType() === Model, "belongsToMany relation requires collection of \"" + Model.name + "\" while receives collection of \"" + items.getType().name + "\"");
                    return this;
                }
                catch (err) {
                }
...
},{"_process":1,"invariant":3,"uuid/v4":6}],3:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./lib/bytesToUuid":4,"./lib/rng":5}]},{},[2])(2)
});