...
var getStore = function (initDefault) {
    ...
    invariant$1(_store, 'Store is not initialized, use "initStore(options) before gettings access to store.');
    return _store;
};
...
var Collection = (function () {
    ...
    Collection.fromArray = function (models) {
        if (Array.isArray(models)) {
            ...
            var items = models.map(function (model) {
                invariant$1(model.constructor === Model_1, 'Collection::fromArray only accept an array of Models with the same schema');
                return model.getKey();
            });
    ...
    Collection.prototype.filter = function (callback) {
        var _this = this;
        invariant$1(typeof callback === 'function', "filter callback argument must be a function");
    ...
    Collection.prototype.map = function (callback) {
        var _this = this;
        invariant$1(typeof callback === 'function', "map callback argument must be a function");
    ...
    Collection.prototype.push = function (item) {
        ...
        invariant$1(this.Model === Model, "push item must be an instance of " + this.getType().name);
    ...
    Collection.prototype.concat = function () {
        ...
        var ids = items.map(function (item) {
            invariant$1(item.constructor === Model, "Collection::concat only accept additional item is instance of " + _this.getType().name);
            return item.getKey();
        });
    ...
    Collection.prototype.unshift = function (item) {
        var Model = get(item, 'constructor');
        invariant$1(this.Model === Model, "unshift item must be an instance of " + this.getType().name);
    ...
    Collection.prototype.reduce = function (callback, initialValue) {
        var _this = this;
        invariant$1(typeof callback === 'function', "reduce callback argument must be a function");
    ...
    Collection.prototype.splice = function (startIndex, deleteCount) {
        ...
        if (newItems.length) {
            ...
            newItemIds = newItems.map(function (item) {
                invariant$1(item.constructor === Model_2, "splice only accept new item instance of " + _this.getType().name);
                return item.getKey();
            });
        }
...
var Field = function (options) {
    ...
    return function (target, property) {
        ...
        setDefinition(target.constructor, property, __assign({}, options, { name: 'Field', type: Field, ensureData: function (data, opt) {
                ...
                // check required
                invariant$1(!(isRequired && val === undefined), "Missing value for required field " + property);
        ...
        Object.defineProperty(target, property, {
            ...
            set: function (items) {
                ...
                try {
                    ...
                    invariant$1(col.getType() === Model, "hasMany relation requires collection of \"" + Model.name + "\" while receives collection of \"" + col.getType().name + "\"");
        ...
        Object.defineProperty(target, property, {
            ...
            set: function (items) {
                ...
                try {
                    ...
                    invariant$1(items.getType() === Model, "belongsToMany relation requires collection of \"" + Model.name + "\" while receives collection of \"" + items.getType().name + "\"");
                    return this;
                }
                catch (err) {
                }
