...
import { get, isEqual, isMatch, memoize, set, toUpper } from 'lodash';
import { computed, extendObservable, observable, observe, transaction, untracked } from 'mobx';
import { v4 } from 'uuid';
...
var Column = function (options) {
    ...
    return function (target, property) {
        ...
        setDefinition(target.constructor, property, __assign({}, options, { name: 'Column', type: Column, defaultValue: defaultValue, ensureData: function (data, opt) {
                if (opt === void 0) { opt = {}; }
...
var Model = /** @class */ (function () {
    function Model(data) {
        ...
        var defs = listDefinitions(this.constructor);
        var obj = {};
        defs.forEach(function (def, prop) {
            var type = def.type, defaultValue = def.defaultValue;
            if (type === Column) {
    ...
    Model.find = function (cond, options) {
        ...
        if (this._store.computes.has(condHash)) {
            ...
            var genComputor_1 = memoize(function (instance) {
                return computed(function () {
                    var isMatched = isMatch(instance, cond);
